...
point4 cubePoints [numCubeVertices*2];
point3 cubeNormals[numCubeVertices*2];
point2 cubeUV     [numCubeVertices*2];
...
//    to the vertices
int Index = 0;
void quad( int a, int b, int c, int d, const point3& normal, GLfloat theta )
//{
//    GLfloat dist = (0.002777) * theta;
//    cubePoints[Index] = vertices[a]; cubeNormals[Index] = normal; 
//    cubeUV[Index] = point2(-01.250f + dist, 1.5f); Index++;
//    cubePoints[Index] = vertices[b]; cubeNormals[Index] = normal;
//    cubeUV[Index] = point2(-01.250f + dist, -0.50f); Index++;
//    cubePoints[Index] = vertices[c]; cubeNormals[Index] = normal;
//    cubeUV[Index] = point2(0.750f + dist, -0.50f); Index++;
//    cubePoints[Index] = vertices[a]; cubeNormals[Index] = normal;
//    cubeUV[Index] = point2(-01.250f + dist, 1.50f); Index++;
//    cubePoints[Index] = vertices[c]; cubeNormals[Index] = normal;
//    cubeUV[Index] = point2(0.750f + dist, -0.50f); Index++;
//    cubePoints[Index] = vertices[d]; cubeNormals[Index] = normal;
//    cubeUV[Index] = point2(0.750f + dist, 1.50f); Index++;
//}
{
    cubePoints[Index] = vertices[a]; cubeNormals[Index] = normal;
...
void quad1( int a, int b, int c, int d, const point3& normal, GLfloat theta)
{
    GLfloat radius = sqrt(2)/2;
    cubePoints[Index] = vertices[a]; cubeNormals[Index] = normal;
    cubeUV[Index] = point2((radius*cos((theta+225+270)*DegreesToRadians))+0.5, (radius*sin((theta+225+270)*DegreesToRadians))+0.5); Index++;
    cubePoints[Index] = vertices[b]; cubeNormals[Index] = normal;
    cubeUV[Index] = point2((radius*cos((theta+225)*DegreesToRadians))+0.5, (radius*sin((theta+225)*DegreesToRadians))+0.5); Index++;
    cubePoints[Index] = vertices[c]; cubeNormals[Index] = normal;
    cubeUV[Index] = point2((radius*cos((theta+225+90)*DegreesToRadians))+0.5, (radius*sin((theta+225+90)*DegreesToRadians))+0.5); Index++;
    cubePoints[Index] = vertices[a]; cubeNormals[Index] = normal;
    cubeUV[Index] = point2((radius*cos((theta+225+270)*DegreesToRadians))+0.5, (radius*sin((theta+225+270)*DegreesToRadians))+0.5); Index++;
    cubePoints[Index] = vertices[c]; cubeNormals[Index] = normal;
    cubeUV[Index] = point2((radius*cos((theta+225+90)*DegreesToRadians))+0.5, (radius*sin((theta+225+90)*DegreesToRadians))+0.5); Index++;
    cubePoints[Index] = vertices[d]; cubeNormals[Index] = normal;
    cubeUV[Index] = point2((radius*cos((theta+225+180)*DegreesToRadians))+0.5, (radius*sin((theta+225+180)*DegreesToRadians))+0.5); Index++;
}
//{
//    cubePoints[Index] = vertices[a]; cubeNormals[Index] = normal;
//    cubeUV[Index] = point2(0.0f, 1.0f); Index++;
...
void colorcube(GLfloat theta)
{
    quad( 1, 0, 3, 2, point3( 0.0f,  0.0f,  1.0f), theta );
    quad( 2, 3, 7, 6, point3( 1.0f,  0.0f,  0.0f), theta );
    quad( 3, 0, 4, 7, point3( 0.0f, -1.0f,  0.0f), theta );
    quad( 6, 5, 1, 2, point3( 0.0f,  1.0f,  0.0f), theta );
    quad( 6, 7, 4, 5, point3( 0.0f,  0.0f, -1.0f), theta );
    quad( 5, 4, 0, 1, point3(-1.0f,  0.0f,  0.0f), theta );
}

void colorcube1(GLfloat theta)
{
    quad1( 1, 0, 3, 2, point3( 0.0f,  0.0f,  1.0f), theta );
    quad1( 2, 3, 7, 6, point3( 1.0f,  0.0f,  0.0f), theta );
    quad1( 3, 0, 4, 7, point3( 0.0f, -1.0f,  0.0f), theta );
    quad1( 6, 5, 1, 2, point3( 0.0f,  1.0f,  0.0f), theta );
    quad1( 6, 7, 4, 5, point3( 0.0f,  0.0f, -1.0f), theta );
    quad1( 5, 4, 0, 1, point3(-1.0f,  0.0f,  0.0f), theta );
}

// initialization
void generateCube(GLuint program, ShapeData* cubeData, GLfloat theta)
{
    Index = 0;
    colorcube(theta);
    colorcube1(theta);
